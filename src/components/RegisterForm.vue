<template>
  <div
    class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-light via-gray-600 to-green-medium px-4 sm:px-6 lg:px-8"
  >
    <div class="max-w-md w-full space-y-4">
      ...
      <form @submit.prevent="handleRegister" class="mt-8 space-y-6">
        <div
          class="bg-white/15 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/25 ring-1 ring-green-light/20"
        >
          <div class="space-y-6">
            <div>
            ...
            <div class="flex items-center">
              ...
              <label for="terms" class="ml-2 block text-sm text-white">
                ...
                <a
                  href="#"
                  class="text-green-light hover:text-green-medium transition-colors underline"
                >
                  termos de uso
                </a>
                e
...
import { useUserIdentityService, useFormValidation, useToast } from '@/composables'
...
const handleRegister = async () => {
  ...
  try {
    await toastPromise(userIdentityService.register(registerRequest), {
